/* rateAnswer NAMESPACE
 ============================================================== */
const rateAnswer = function() {
  const loadAnswers = function loadAnswers() {
  ...
  const rateAnswer = function rateAnswer() {
  ...
  // rateAnswer namespace will reveal the following properties
  return {
...
$(document).ready(function(){
    ...
    rateAnswer.loadAnswers();
    rateAnswer.loadUsers();
});