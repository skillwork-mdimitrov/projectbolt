...
const unfoldingHeader = function () {
 ...
 ============================================================== */
  const unfoldHeader = function(textToDisplay, color) {
    ...
    switch(color) {
      case "green":
        foldingHeader.css("background-color", "rgb(2, 237, 112)"); // Fallback solid green
        foldingHeader.css("background-color", "rgba(2, 237, 112, 0.7)"); // Semi-transparent green
        break;
      case "red":
        foldingHeader.css("background-color", "rgb(139, 0, 0)"); // Fallback solid red
        foldingHeader.css("background-color", "rgba(139, 0, 0, 0.7)"); // Semi-transparent red
        break;
      case "orange":
        foldingHeader.css("background-color", "rgb(255, 169, 10)"); // Fallback solid orange
        foldingHeader.css("background-color", "rgba(255, 169, 10, 0.7)"); // Semi-transparent orange
        headerInfo.css("color", "black");
        break;
      default:
